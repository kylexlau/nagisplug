...
# How to test:
# notify-service.rb "$NOTIFICATIONTYPE$" "$HOSTNAME$" "$HOSTADDRESS$" "$SERVICEDESC$" "$SERVICESTATE$" "$SERVICEOUTPUT$" "$LONGDATETIME$" "$CONTACTEMAIL$"
# notify-service.rb DOWNTIMESTART HD-CW-GDB01 172.25.27.129 CPU_LOAD OK OK 2011-11-01:10:00 liuxk@szlanyou.com
